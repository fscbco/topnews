...
ActiveRecord::Schema[7.0].define(version: 2024_08_08_154536) do
  ...
  create_table "starred_stories", force: :cascade do |t|
    ...
    t.index ["user_id", "story_id"], name: "index_starred_stories_on_user_id_and_story_id", unique: true
  ...
  create_table "stories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["hacker_news_id"], name: "index_stories_on_hacker_news_id", unique: true
  end
