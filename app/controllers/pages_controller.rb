class PagesController < ApplicationController
    ...
    def get_stories_for_ids(ids, limit=nil)
        ...
        ids.each do |id|
            ...
            story = Story.new(title: story_json["title"], author: story_json["by"], url: story_json["url"], api_id: story_json["id"], object_type: story_json["type"], time_posted: story_json["time"])
