...
class StoriesController < ApplicationController
  ...
  def index
    ...
    stories.each do |story|
      story_hash = {id: story.id, hn_id: story.hn_id, title: story.title, url: story.url, starred: false, starred_by: []}
      if story.stars.length > 0
  ...
  # def starred_stories
  #   starred_stories = Star.all.map {|star| star.story}
  #   render json: starred_stories
  # end
