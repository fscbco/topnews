...
describe "fetching the top stories off hacker news" do
  context "fetching a top stories for the first time" do
    it "creates story records for each story" do
      ...
      stub_request(:get, "https://hacker-news.firebaseio.com/v0/item/1.json").to_return_json(body: {"by" => author1, "title" => title1})
      stub_request(:get, "https://hacker-news.firebaseio.com/v0/item/2.json").to_return_json(body: {"by" => author2, "title" => title2})
  ...
  context "fetching a top stories for the second time" do
    it "finds the exising stories instead of creating them again" do
      stub_request(:get, "https://hacker-news.firebaseio.com/v0/topstories.json").to_return_json(body: ["1","2"])
      stub_request(:get, "https://hacker-news.firebaseio.com/v0/item/1.json").to_return_json(body: {"by" => "jsmith", "title" => "title1"})
      stub_request(:get, "https://hacker-news.firebaseio.com/v0/item/2.json").to_return_json(body: {"by" => "msmith", "title" => "title2"})
